...
/** PLMScrollMenuBarController Transition Delegate Protocol
 */
...
/** PLMScrollMenuInteractiveTransition
*/
public class PLMScrollMenuInteractiveTransition : NSObject , UIViewControllerInteractiveTransitioning
{
    ...
    /** Cancel
     */
    private func cancelInteractiveTransitionWithCompletion(completion: (()->()) )
    {
    ...
    {
        // print("InteractiveTransition finishInteractiveTransition")
...
// MARK: - ContextTransitioning
/**
* PLMScrollMenuBarController TransitionContext
*/
